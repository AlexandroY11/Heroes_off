...
export class MultheroeService {
  ...
  crud_multimediasHeroes(unaMultimediaHeroe: MultimediaHeroe, unaAccion: string): any {
    if (unaAccion === 'eliminar') {
      let parametros2 = new HttpParams();
    ...
    if (unaAccion === 'insertar') {
      ...
      parametros2 = parametros2.append('IdMultimedia', unaMultimediaHeroe.IdMultimedia);
    ...
    if (unaAccion === 'modificar') {
      ...
      // Begin assigning parameters
      parametros = parametros.append('IdMultimedia', unaMultimediaHeroe.IdMultimedia);
